        ...
        <div className="w-2/3 text-neutral-500">
          <Reveal>
            <p className="mb-5">
              ...
              applications. Drawing from my background in graphic design, I
              bring a unique perspective to translating design concepts into
              responsive web apps. My current obsession is React, and I&apos;m
              dedicated to mastering it. However, I&apos;m a fast learner and
              enjoy the process of acquiring new technologies and tools that are
              best suited for each project&apos;s needs.
            </p>
          </Reveal>
          <Reveal>
            <p className="mb-5">
          ...
          <Reveal>
            <p className="mb-5">
              ...
              providing entertainment but also allowing me to create meaningful
              connections with people from all over the world. Through my
              involvement in the gaming and esports community, I discovered my
              passion for design and technology. Apart from gaming, I love
              watching TV shows, movies, and anime with my wife. These shared
              experiences create moments of joy and excitement that fuel my
              creativity. Spending time with close friends is also a crucial
              aspect of my life, whether it&apos;s playing board games or
